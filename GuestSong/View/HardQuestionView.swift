        ...
        ZStack {
            ...
            VStack(spacing: 20) {
                ...
                if !viewModel.isQuizFinished {
                    if viewModel.currentQuestionIndex < viewModel.hardQuiz.count {
                        let currentSong = viewModel.hardQuiz[viewModel.currentQuestionIndex]
                        ...
                        HStack {
                            Text("Time: \(viewModel.timeRemaining) seconds")
                                ...
                                .fontWeight(.bold)
                            Spacer()
                            Text("\(viewModel.currentQuestionIndex+1) out of \(viewModel.hardQuiz.count)")
                        ...
                        ProgressBar(progress: CGFloat(viewModel.currentQuestionIndex) / CGFloat(viewModel.hardQuiz.count))
                    ...
                    AnimationView(name: "Congrats", animationSpeed: 0.5)
                        ...
                        .padding(.top, 150)
                    Text("Your Score: \(viewModel.score) out of \(viewModel.hardQuiz.count)")
                        .padding()
